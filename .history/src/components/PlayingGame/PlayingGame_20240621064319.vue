...
export default {
  ...
  methods: {
    ...
    selectAnswer(index) {
      clearInterval(this.intervalId);
      this.notificationStep = 0; // Reset step
    ...
    correctAnswerSequence() {
      ...
      const newScore = oldScore + baseScore + timeBonus;
      ...
      this.showNotificationMessage(
        ...
        true,
        () => {
          this.animateScore(oldScore, oldScore + baseScore, () => {
            this.showNotificationMessage(`+100 points`, true, () => {
              this.animateScore(oldScore + baseScore, newScore, () => {
                this.showNotificationMessage(
